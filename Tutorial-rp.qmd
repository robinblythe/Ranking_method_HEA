...
The `pmsampsize` package is a great resource and demonstrates sample size requirements for prediction models. We can use it to determine the conditions for training our hypothetical prediction model. I typically specify slightly more parameters than predictors in the dataset to deal with potential interactions or non-linearity, so I'll specify 2 parameters here even if we're only using 1 in our hypothetical.
