...
-   Additional costs due to deterioration
    -   The additional cost of deterioration is \~𝒩(14134, 686) [@Curtis2021]
...
By repeating the sample population simulation step for a selection of prevalence and AUC values, we can mimic an external validation study across a variety of external settings, using the original model predictors derived from the initial parameterisation.
