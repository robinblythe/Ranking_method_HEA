...
2.  Maybe we quantify how much time clinicians can dedicate to this (e.g. 15 alerts max) - see Romero-Brufau approach
3.  Repeat the analysis for a miscalibrated model?
